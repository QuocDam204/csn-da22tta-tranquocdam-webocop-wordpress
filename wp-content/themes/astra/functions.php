...
function register_custom_menu() {
    register_nav_menu('custom-menu', __('Custom Horizontal Menu'));
}
add_action('init', 'register_custom_menu');

function enqueue_custom_scripts() {
    // Đảm bảo sử dụng đúng đường dẫn tới file style.js
    wp_enqueue_script(
        'custom-style-js', 
        get_stylesheet_directory_uri() . '/menu_ngang.js', // Đường dẫn tới file
        array('jquery'), // Đặt phụ thuộc nếu cần (ví dụ: jQuery)
        null, // Phiên bản (có thể để null)
        true // Đặt true để tải trong footer
    );
}
