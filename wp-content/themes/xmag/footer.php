...
?>
    ...
    <hr style="border-top: 3px solid #5cb85c; width: 98vw; position: relative; left: 50%; transform: translateX(-50%);">
	...
	<footer id="colophon" class="site-footer" role="contentinfo" >
		...
		<div class="footer widget-area" role="complementary" >
			<div class="container" >
				<div class="row">
					<div class="col-4" id="footer-area-left" style="background-color:#fff;">
		...
		<div class="footer-copy" style="background-color: #5cb85c;">
			<div class="container">
				<div class="row">
					<div class="col-6">
						<div class="site-info">
